...
import LogoIeee from "/logoessalud22.svg"
...
const DashHeader = () => {
  ...
  // list menu
  const menu = ["Conocenos", "Eventos", "Noticias", "Autoridades", "Ubicanos"]
  ...
  return (
    <>
      ...
      {/* header nav toggle */}
      <div
        className={`fixed top-0 z-20 flex h-screen w-full flex-col items-center bg-white text-header duration-500 ease-in-out xl:hidden ${toggleMenu ? `left-0` : "left-full"
          }`}
      >
